...
for i = 1:numVars
    ...
    % racunanje skewnessa za svaku kolonu
        skewness_vrednost_pre{i} = skewness(trenutna_kolona_pre,0); % 0 je statisticki flag
        skewness_vrednost_posle{i} = skewness(trenutna_kolona_posle, 0); % 0 je statisticki flag
