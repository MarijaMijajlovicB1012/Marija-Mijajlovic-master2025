...
T_data_matrix_input.pop_density = log10(T_data_matrix_input.pop_density);
...
T_data_matrix_input.cardiovasc = log10(T_data_matrix_input.cardiovasc);
...
T_data_matrix_input.mobility_retail = log10(T_data_matrix_input.mobility_retail-min(T_data_matrix_input.mobility_retail));
T_data_matrix_input.mobility_grocery = log10(T_data_matrix_input.mobility_grocery-min(T_data_matrix_input.mobility_grocery));
...
T_data_matrix_input.R_mean = log10(T_data_matrix_input.R_mean);
